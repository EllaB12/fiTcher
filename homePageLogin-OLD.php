...
<head>
  ...
  <link href="CSS/styleCopy.css" rel="stylesheet">
    ...
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
            ...
            <li class="dropdown"><a href="">שלום <?php echo $user_with_password->get_userName();?><i class="fas fa-angle-down"></i></a>
            <ul>
            <div class="dropdown">
                 <div class="dropdown-content">
                 <?php if ($permission == 2){
                    echo "<a href='indexTeacher.php'>אזור אישי</a>";
                }
                else{
                    echo "<a href='indexStudent.php'>אזור אישי</a>";
                }
                ?>
                  <a href="#">יציאה</a>
                </div>
          ...
          <li><a href="indexStudent.php">צור קשר</a></li>
